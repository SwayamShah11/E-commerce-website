...
import json
# (from django.views.decorators.csrf import csrf_exempt) ye paytm k liye use hoga
from django.http import HttpResponse

# [MERCHANT_KEY = 'kbzk1DSbJiV_03p5'] jab paytm integrate hoga tab kaam aayega
